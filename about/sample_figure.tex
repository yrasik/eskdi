...
\center{\includegraphics[width=0.7\linewidth]{./about/func_in} \\ а)}
\end{minipage}
\hfill
\begin{minipage}[h]{0.49\linewidth}
\center{\includegraphics[width=0.7\linewidth]{./about/func_in} \\ б)}
\end{minipage}
...
\begin{tikzpicture}
	\begin{pgfonlayer}{nodelayer}
		\node [style=none] (0) at (-4.5, 3) {ПРИВЕТ};
		\node [style=none] (1) at (-6, 3.75) {};
		\node [style=none] (2) at (-6, 2.25) {};
		\node [style=none] (3) at (-3, 2.25) {};
		\node [style=yellow square] (4) at (-3, 3.75) {};
	\end{pgfonlayer}
