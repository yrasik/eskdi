...
\spboxmm{0}{275}{0}{275}{lc}{\parbox{180mm}{\centering \normalfont МУНИЦИПАЛЬНОЕ БЮДЖЕТНОЕ ОБЩЕОБРАЗОВАТЕЛЬНОЕ\\УЧРЕЖДЕНИЕ\\СРЕДНЯЯ ОБЩЕОБРАЗОВАТЕЛЬНАЯ ШКОЛА № 11 ИМ. А. С. ПУШКИНА}}%
}%

\renewcommand\titleCENTERI{%
\spboxmm{22}{180}{162}{180}{lc}{\parbox{140mm}{\centering \Large{Экология. Исследовательский проект}\\\vspace{4mm}\large{Уровень загрязнения СО на остановках общественного транспорта города Воронежа}}}%
}%

\renewcommand\titleBotRIGHTI{%
  \spboxmm{110}{120}{110}{120}{lc}{\parbox{70mm}{\raggedright Автор\\\raggedright ученица 8 «А» класса\\Степаненко Наталья\\\vspace{4mm}\raggedright Руководитель\\\raggedright учитель химии\\Голубничая Мария Андреевна}}%
}%


\renewcommand\titleCENTERII{%
\spboxmm{0}{15}{0}{15}{lc}{\parbox{180mm}{\centering Воронеж 2022}}%
}%
...
%\renewcommand\titlePicture{\AddToShipoutPicture{\AtPageLowerLeft{\includegraphics[width=210mm, height=297mm, viewport=2.0mm 14.0mm 210.0mm 311.0mm]{\pathtosharedresource background20}}}}%
