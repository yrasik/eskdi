...
\input ./content/title.tex %Здесь информация о названии файла, авторах и т.д.
...
\input ./content/about_begin.tex
\input ./content/about_latex.tex
\input ./content/about_bibliography.tex
