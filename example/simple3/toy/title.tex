...
\gosttitleobject{\vspace{-15mm} \LARGE Животные Воронежского края \\ \vspace{5mm} \huge Европейская болотная черепаха}}
\gosttitleobjectI{Черепаха}

\gosttitledocument{\vspace{5mm}Реферат}
...
\gostrazrabotchikFIO{\vspace{15mm} Наташа Степаненко}
...
%\renewcommand\titlePicture{\AddToShipoutPicture{\AtPageLowerLeft{\includegraphics[width=210mm, height=297mm, viewport=2.0mm 14.0mm 210.0mm 311.0mm]{\pathtosharedresource background12}}}}%
