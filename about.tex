...
\usepackage{minted} % Пакет для листингов. Для работы нужен интерпретатор 'pythone', 'pip install Pygments' и прописать PATH к этому всему... Подробней  https://pygments.org/
...
\usepackage{tikzit} %Это для включения рисунков, сделанных в редакторе TikZiT
